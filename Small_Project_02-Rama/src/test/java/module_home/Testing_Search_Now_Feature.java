...
public class Testing_Search_Now_Feature {
    @Test
    public void SC3_TC1() throws InterruptedException {
        ...
        System.out.println("SC3_TC1 : Hotel Location Input testing complete");
    ...
    public void SC3_TC2() throws InterruptedException {
        ...
        System.out.println("SC3_TC2 : Select Hotel complete");
    ...
    @Test
    public void SC3_TC3() throws InterruptedException {
        ...
        System.out.println("SC3_TC3 : Check In date complete");

        driver.close();
    }

    @Test
    public void SC3_TC4() throws InterruptedException {
        ...
        System.out.println("SC3_TC4 ; Check out date complete");

        driver.close();
    }

    @Test
    public void SC3_TC5() throws InterruptedException {
        ...
        System.out.println("SC3_TC5 : Testing Search now without filling anything complete");

        driver.close();
    }

    @Test
    public void SC3_TC6() throws InterruptedException {
        ...
        System.out.println("SC3_TC5 : Testing Filled Shopping cart complete");
    ...
    public void Scenario() {
        ...
        System.out.println("Scenario Testing Search Now Feature Success");
    }
}